...
config.font = wezterm.font("UbuntuMono Nerd Font Mono", { weight = "Medium", stretch = "Normal", style = "Normal" }) -- (AKA: JetBrainsMono NFM, JetBrainsMono NFM Medium) /usr/share/fonts/JetBrainsMonoNerdFontMono-Medium.ttf, FontConfig
